...
import { SortColumn, SortDirection } from './monthlysale-sortable.directive';
 ...
 */
function matches(table: MonthlySale, term: string, pipe: PipeTransform) {
  return (
...
export class MonthlySaleService {
  // tslint:disable-next-line: variable-name
  private _loading$ = new BehaviorSubject<boolean>(true);
  // tslint:disable-next-line: variable-name
  private _search$ = new Subject<void>();
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<MonthlySale[]>([]);
  // tslint:disable-next-line: variable-name
