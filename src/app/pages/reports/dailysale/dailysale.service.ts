...
import { SortColumn, SortDirection } from './dailysale-sortable.directive';
 ...
 */
function matches(table: DailySale, term: string, pipe: PipeTransform) {
  return (
...
export class DailySaleService {
  ...
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<DailySale[]>([]);
  // tslint:disable-next-line: variable-name
