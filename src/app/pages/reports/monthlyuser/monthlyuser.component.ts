...
import {
  ...
  SortEvent,
} from './monthlyuser-sortable.directive';
import { MonthlyUser } from './monthlyuser.model';
import { MonthlyUserService } from './monthlyuser.service';
import * as XLSX from 'xlsx';

@Component({
  selector: 'app-monthlyuser',
  templateUrl: './monthlyuser.component.html',
  styleUrls: ['./monthlyuser.component.scss'],
  providers: [MonthlyUserService, DecimalPipe],
})

/**
 * MonthlyUser Component
 */
export class MonthlyUserComponent implements OnInit {
  // bread crumb items
  ...
  hideme: boolean[] = [];
  tables$!: Observable<MonthlyUser[]>;
  total$!: Observable<number>;

  company: any;
  getCompanys!: Observable<any>;
  companysCollection!: AngularFirestoreCollection<MonthlyUser>;

  tableData!: MonthlyUser[];
  totalData!: number;
  ...
  export() {
    ...
    /* save to file */
    XLSX.writeFile(wb, 'Monthly-User-Report.xlsx');
  }
}
