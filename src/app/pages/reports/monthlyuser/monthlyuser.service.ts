...
import { SortColumn, SortDirection } from './monthlyuser-sortable.directive';
 ...
 */
function matches(table: MonthlyUser, term: string, pipe: PipeTransform) {
  return (
...
export class MonthlyUserService {
  // tslint:disable-next-line: variable-name
  private _loading$ = new BehaviorSubject<boolean>(true);
  // tslint:disable-next-line: variable-name
  private _search$ = new Subject<void>();
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<MonthlyUser[]>([]);
  // tslint:disable-next-line: variable-name
