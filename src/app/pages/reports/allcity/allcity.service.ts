...
import { SortColumn, SortDirection } from './allcity-sortable.directive';
 ...
 */
function matches(table: AllCity, term: string, pipe: PipeTransform) {
  return (
...
export class AllCityService {
  ...
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<AllCity[]>([]);
  // tslint:disable-next-line: variable-name
