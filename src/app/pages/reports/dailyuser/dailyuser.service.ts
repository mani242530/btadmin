...
import { SortColumn, SortDirection } from './dailyuser-sortable.directive';
 ...
 */
function matches(table: DailyUser, term: string, pipe: PipeTransform) {
  return (
...
export class DailyUserService {
  // tslint:disable-next-line: variable-name
  private _loading$ = new BehaviorSubject<boolean>(true);
  // tslint:disable-next-line: variable-name
  private _search$ = new Subject<void>();
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<DailyUser[]>([]);
  // tslint:disable-next-line: variable-name
