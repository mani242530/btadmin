...
import { SortColumn, SortDirection } from './updatedrecord-sortable.directive';
import { UpdatedRecord } from './updatedrecord.model';

interface SearchResult {
  tables: UpdatedRecord[];
  total: number;
}
 ...
 */
function matches(table: UpdatedRecord, term: string, pipe: PipeTransform) {
  return (
...
export class UpdatedRecordService {
  ...
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<UpdatedRecord[]>([]);
  // tslint:disable-next-line: variable-name
